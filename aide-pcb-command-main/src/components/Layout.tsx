...
import {
  ...
  ChevronLeft, ChevronRight, Radio, Server, Camera, FileText, Sparkles
} from "lucide-react";
...
const navItems = [
  ...
  { title: "AR Vision", path: "/ar-vision", icon: Camera },
  ...
  { title: "Data Reports", path: "/reports", icon: FileText },
  { title: "Plan Generator", path: "/planning", icon: Sparkles },
];
